...
class ReadExcel(object):
    ...
    def project_if_exist(self):
        ...
        if self.jiraname in existproject:
            ...
            new_project_sheet.write(1, 1, '不符合项', style)
            new_project_sheet.write(1, 2, '责任人', style)
            new_project_sheet.write(1, 3, '检查时间', style)
            new_project_sheet.write(1, 5, '已检查到', style)
            new_project_sheet.write(2, 5, self.jiraname + '-1')
